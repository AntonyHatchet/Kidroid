...
socket.on('category', function (school) {
    ...
    for (var i = 0; i < school.length; i++) {
        html += "<tr><td style=\'display: none\'>" + school[i]._id + "</td><td>" + school[i].name + "</td><td><button class='btn btn-default' type='button' onclick=\'socket.emit(\"removeCategory\",\"" + school[i]._id + "\")\')>remove</button> / <a href=\'#editCategory\'><button class='btn btn-default'>edit</button></a></td></tr>";
    }
